...
typedef struct BITMAP_FILE_TAG {
  ...
  BITMAPINFOHEADER
      bitmapinfoheader;      // this is all the info including the palette
...
int Scan_Image_Bitmap(BITMAP_FILE_PTR bitmap, LPDIRECTDRAWSURFACE7 lpdds,
                      int cx, int cy);
int Scan_Image_Bitmap16(BITMAP_FILE_PTR bitmap, LPDIRECTDRAWSURFACE7 lpdds,
                        int cx, int cy, int sizex, int sizey);
...
int Draw_Line(int xo, int yo, int x1, int y1, UCHAR color, UCHAR* vb_start,
              int lpitch);
