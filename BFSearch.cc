...
Queue * doBFS(int i,int j, int goal, int maxDepth)
{
	...
	switch(goal)
	{
	case 2: goalFunc = goalPlaceBomb;break;
	case 1: goalFunc = goalSafe;
		canGoFunc = BFSCanGoSafe;
		break;
	case 100: goalFunc = goalPowerUp;break;
	case 200: 
	case 201: 
	case 202:
	case 203:goalFunc = goalFight;g_playerNum=(goal-200);break;
	default: goalFunc = goalSafe;break;
	}
